              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="space-y-1 text-sm mt-2">
                  ...
                  <input
                    ...
                    name="email"
                    placeholder="Email"
                    className="w-full px-4 py-2 rounded-md border border-gray-300 bg-gray-50 text-gray-800"
                  />
                </div>
                <div className="space-y-1 text-sm mt-2">
                ...
                <div className="flex justify-between">
                  <div className="space-y-1 text-sm mt-2 w-2/5">
                ...
                <button
                  type="submit"
                  className="block w-1/2 mx-auto mt-6 p-3 text-center rounded-md text-gray-50 bg-green-600 hover:opacity-50 duration-300"
                >
                  Create an account
                </button>
              </form>
